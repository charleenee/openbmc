...
<<<<<<< HEAD
  BIC_SENSOR_P1V08_PCH_STBY_VOL = 0x23,
  BIC_SENSOR_P1V05_PCH_STBY_VOL = 0x24,
  BIC_SENSOR_HSC_INPUT_VOL = 0x26,
  BIC_SENSOR_VCCIN_VR_VOL = 0x27,
  BIC_SENSOR_FIVRA_VR_VOL = 0x28,
  BIC_SENSOR_EHV_VR_VOL =0x29,
  BIC_SENSOR_VCCD_VR_VOL = 0x2A,
  BIC_SENSOR_FAON_VR_VOL = 0x2C,
=======
