...
>>>>>>> facebook/helium
  ...
  BIC_GPV3_DUAL_M2_PWR_0_1 = 0x44,
  BIC_GPV3_DUAL_M2_PWR_2_3 = 0x45,
  BIC_GPV3_DUAL_M2_PWR_4_5 = 0x47,
  BIC_GPV3_DUAL_M2_PWR_6_7 = 0x48,
  BIC_GPV3_DUAL_M2_PWR_8_9 = 0x4E,
  BIC_GPV3_DUAL_M2_PWR_10_11 = 0x4F,
  ...
  //CWC BIC sensors
  BIC_CWC_SENSOR_OUTLET_TEMP_T = 0x80,
  BIC_CWC_SENSOR_PCIE_SWITCH_T = 0x81,
  BIC_CWC_SENSOR_NUM_V_12 = 0x82,
  BIC_CWC_SENSOR_NUM_V_3_3_S = 0x83,
  BIC_CWC_SENSOR_NUM_V_1_8 = 0x84,
  BIC_CWC_SENSOR_NUM_V_5 = 0x85,
  BIC_CWC_SENSOR_NUM_P_P1V8_VR = 0x86,
  BIC_CWC_SENSOR_NUM_V_P1V8_VR = 0x87,
  BIC_CWC_SENSOR_NUM_C_P1V8_VR = 0x88,
  BIC_CWC_SENSOR_NUM_T_P1V8_VR = 0x89,
  BIC_CWC_SENSOR_NUM_P_P0V84_VR = 0x8A,
  BIC_CWC_SENSOR_NUM_V_P0V84_VR = 0x8B,
  BIC_CWC_SENSOR_NUM_C_P0V84_VR = 0x8C,
  BIC_CWC_SENSOR_NUM_T_P0V84_VR = 0x8D,
  BIC_CWC_SENSOR_NUM_P_3V3_AUX = 0x8E,
  BIC_CWC_SENSOR_NUM_V_3V3_AUX = 0x8F,
  BIC_CWC_SENSOR_NUM_C_3V3_AUX = 0x90,
  BIC_CWC_SENSOR_NUM_P_HSC_CWC = 0x91,
  BIC_CWC_SENSOR_NUM_V_HSC_CWC = 0x92,
  BIC_CWC_SENSOR_NUM_C_HSC_CWC = 0x93,
  BIC_CWC_SENSOR_NUM_T_HSC_CWC = 0x94,
  BIC_CWC_SENSOR_NUM_P_HSC_BOT = 0x95,
  BIC_CWC_SENSOR_NUM_V_HSC_BOT = 0x96,
  BIC_CWC_SENSOR_NUM_C_HSC_BOT = 0x97,
  BIC_CWC_SENSOR_NUM_T_HSC_BOT = 0x98,
  BIC_CWC_SENSOR_NUM_P_HSC_TOP = 0x99,
  BIC_CWC_SENSOR_NUM_V_HSC_TOP = 0x9A,
  BIC_CWC_SENSOR_NUM_C_HSC_TOP = 0x9B,
  BIC_CWC_SENSOR_NUM_T_HSC_TOP = 0x9C,
